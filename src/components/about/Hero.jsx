      ...
      <div className="size-full relative overflow-hidden flex flex-col justify-between items-center">
        ...
        >
          <div className=" flex xl:w-1/12 justify-center">
            <img
              ...
              alt="Logo"
              className="h-17.5 w-17.5 cursor-pointer "
              onClick={() => navigate("/")}
            />
          </div>
        ...
        <div className=" w-full flex justify-center">
          <div className=" flex justify-center flex-col items-center gap-2">
            <span className="rasa text-[30px] md:text-[50px] xl:text-[70px] text-white font-bold flex">
              About : <span className="text-[#bb0573]"> Square M Reality</span>
            </span>
            <span className="readex text-white text-[15px] md:text-[18px] xl:text-[20px] text-center max-sm:ps-2! max-sm:pe-2! md:ps-10! md:pe-10!">
              {" "}
              Blending creative design with engineering excellence to build
              spaces that stand out and stand strong.
            </span>
            <a
              href="/contact"
              className="text-black! no-underline! btn-bg-clr p-2 ps-4 pe-4 rounded-full readex"
            >
              Contact Us
            </a>
          </div>
        ...
        >
          <div>
            <a
              href="tel:+917854216589"
              className="flex gap-1 text-white no-underline!"
            >
              <Phone color={"white"} />
              7854326589
            </a>
            <a
              href="mailto:squareM@gmail.com"
              className="flex gap-1 text-white no-underline!"
            >
              {" "}
              <Globe color="white" />
