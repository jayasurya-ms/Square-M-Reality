        ...
        <div className='service-top row w-100'>
          <div className='col-sm-12 col-md-6 p-0'>
            <div className='service-top2 d-flex align-items-start w-100'>
              <span className='service-title solitreo text-white ps-5 mt-10! w-100'>Services We <br />Offer</span>
            </div>
          </div>
          <div className='col-sm-12 col-md-6 p-0'>
            ...
            <div className='h-50 md:flex max-sm:flex align-items-center justify-content-center gap-2 ps-5 xl:hidden max-sm:mt-15! md:mb-5!'>
