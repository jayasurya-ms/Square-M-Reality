    ...
    <div id='c-choose' className='size-full overflow-hidden bg-[#EAE5DF]'>
      <div className='mt-5 mb-5 flex flex-col justify-center items-center'>
        ...
        <div className='flex xl:flex-row md:flex-col max-sm:flex-col items-center w-[90%] mb-6'>
          <div className='xl:text-[60px] max-sm:text-[30px] md:text-[35px] rasa xl:w-[50%] md:w-full max-sm:w-full'>
            Why Choose Us
          </div>
        ...
        <div className='w-full flex justify-center'>
          <div className='w-[95%] max-h-700px max-sm:h-160 md:max-h-170 xl:max-h-none overflow-y-auto xl:overflow-visible grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 p-4'>
            ...
            <div className='flex flex-col gap-2 shrink-0'>
              <div className='w-full aspect-4/5 bg-[url(src/assets/images/r-choose1.jpg)] bg-cover bg-center rounded-3xl'></div>
            ...
            <div className='flex flex-col-reverse xl:flex-col gap-2 shrink-0'>
              ...
              <div className='w-full aspect-4/5 bg-[url(src/assets/images/r-choose2.jpg)] bg-cover bg-center rounded-3xl'></div>
            </div>

            {/* Card 3 */}
            <div className='flex flex-col gap-2 shrink-0'>
              <div className='w-full aspect-4/5 bg-[url(src/assets/images/r-choose3.jpg)] bg-cover bg-center rounded-3xl'></div>
              <div className='w-full bg-white rounded-3xl flex flex-col p-5 gap-2'>
            ...
            <div className='flex flex-col-reverse xl:flex-col gap-2 shrink-0'>
              ...
              <div className='w-full aspect-4/5 bg-[url(src/assets/images/r-choose4.jpg)] bg-cover bg-center rounded-3xl'></div>
            </div>
